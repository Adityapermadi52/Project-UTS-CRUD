...
include '../koneksi.php';
$id = $_GET["id"];
$tampilkan = query("SELECT * FROM datapengunjung WHERE id =$id ")[0];
  ...
  <div class="container">
    ...
    <form action="edit-fungsi.php" method="POST" class="needs-validation" novalidate>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="alamat" placeholder="Masukkan Alamat Lengkap Anda" name="alamat" required>
        <div class="invalid-feedback">Alamat lengkap harus diisi.......!</div>
      </div>
      <div class="form-group">
        <label for="notelepon">No.Telepon:</label>
        <input type="text" class="form-control" id="notelepon" placeholder="Masukkan Notelepon Anda" name="notelepon" required>
        <div class="invalid-feedback">No.Telepon harus diisi.......!</div>
      </div>
      <div class="form-group">
        <label for="email">Email:</label>
        <input type="text" class="form-control" id="email" placeholder="Masukkan email Anda" name="email" required>
